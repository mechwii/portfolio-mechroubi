...
export default function Home(){
    return (
        <div>
            <div className="w-screen h-[100vh] overflow-x-hidden bg-white text-black">
                <Navbar></Navbar>
                ...
                <div className=" mx-48 my-20">
                    <Link href="/experiences/easing">
                        <Experience_card date={experiences[0].date} nomExp={experiences[0].nomExp}
                                         text={experiences[0].text}></Experience_card>
                    </Link>
                </div>
                <Footer></Footer>
            </div>
