...
export const MacbookScroll = ({
    ...
    if(typeof window !== "undefined") {
        window.addEventListener('resize', () => {
            console.log("resize")
            setScreenWidth(isMoreThanScreen());
        })
    }



    const [screenWidth, setScreenWidth] = useState(isMoreThanScreen());
    ...
    return (
        <div
            ref={ref}
            className="md:min-h-[200vh]  flex flex-col items-center md:pt-20 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
        >
            {/* Lid */}
            <Lid
                src={src}
            ...
            />
            {/* Base area */}
            <div className="h-[22rem] w-[32rem] bg-[#b3b4b7] rounded-2xl overflow-hidden relative -z-10">
                {/* above keyboard bar */}
    ...
    return (
        <div className="relative [perspective:800px]">
            ...
            >
                ...
                <Image
                    src={"/img/easing_picture/easingfigma.png"}
                    alt="spark figma page"
                    fill
                    className="object-cover object-left-top absolute rounded-lg rounded-rg inset-0 h-full w-full shadow-lg	"
                />
            </motion.div>
        </div>
    );
