...
export const Chatbot = () => {
    ...
    const messages: Message[] = [
        ...
        { expediteur: "Momo", text: "Oui, car mon tuteur M.Azar a fait son maximum pour que je puisse utiliser les connaissances vues en BUT, en s'imposant des technologies utilisées dans mon cursus comme NodeJs, VueJs, mais aussi MongoDb, en plus de cela il m’a rajouté des missions qui n’étaient pas vraiment pertinentes pour le projet certes, mais qui ont pu m’aider à renforcer mes connaissances comme le système d’authentification." },
        ...
        { expediteur: "Momo", text: "Il n'y a pas vraiment de chose concrète que je changerai mais je pourrai améliorer mon code à certains endroits car certains endroits sont redondants, mais mise à part cela chaque démarche est passée par une étape de réflexion donc avant de faire chaque chose j’ai passé un certain temps à réfléchir." }
    ];
